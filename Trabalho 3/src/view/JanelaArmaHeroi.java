 ...
 * @author fabricio
 */
public class JanelaArmaHeroi extends javax.swing.JFrame {

    ArmaHeroiDAO dao = new ArmaHeroiDAO();
    boolean bancoLigado = false;


    public JanelaArmaHeroi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTF_dano = new javax.swing.JTextField();
        jTF_municao = new javax.swing.JTextField();
        ...
        jLabel1.setText("longa distancia:");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTF_dano, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jTF_municao, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(82, 82, 82)
                                        .addComponent(jLabel1)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(jTextFieldDistancia, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTF_dano, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(3, 3, 3)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(label6, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTF_municao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1)
       ...
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        try{
          if(JDBCUtil.goFirst(dao.getRsdados())){
            System.out.println("primeiro elemento acessado! (ordenado alfabeticamente)");
            ExibeRegistro(dao.getArmaHeroi());
          }
       ...
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        try{
          if(JDBCUtil.goLast(dao.getRsdados())){
            System.out.println("ultimo elemento acessado! (ordenado alfabeticamente)");
            ExibeRegistro(dao.getArmaHeroi());  
          }
        } catch (SQLException ex) {
        ...
        if (dao.CriaConexao()) {
            if (dao.ConsultarTodos()) {
                ...
                try {
                    ...
                    Logger.getLogger(JanelaArmaHeroi.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    private void btn_inserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_inserirActionPerformed
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        ArmaHeroi arma = CarregaArmaHeroi();
        if (dao.Inserir(arma)) {
            JOptionPane.showMessageDialog(this, "Arma inserida com sucesso.");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao inserir Arma.");
        }
    ...
    private void btn_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_alterarActionPerformed
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        ArmaHeroi arma = CarregaArmaHeroi();
        if (dao.Alterar(arma)) {
            JOptionPane.showMessageDialog(this, "Arma alterada com sucesso.");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao alterar Arma.");
        }
    ...
    private void btn_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_excluirActionPerformed
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        ArmaHeroi arma = CarregaArmaHeroi();
        if (dao.Excluir(arma)) {
            JOptionPane.showMessageDialog(this, "Arma excluída com sucesso.");
            btn_primeiroActionPerformed(evt);
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao excluir Arma.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaArmaHeroi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaArmaHeroi().setVisible(true);
            }
        });
    }

    public void ExibeRegistro(ArmaHeroi arma) {
        String longaDistancia;
        if(arma.isLongaDistancia()){
            longaDistancia = "sim";}
        else{
            longaDistancia = "não";}
        
        jTF_id.setText(String.valueOf(arma.getId()));
        jTF_nome.setText(arma.getNome());
        jTF_dano.setText(String.valueOf(arma.getDano()));
        jTF_municao.setText(String.valueOf(arma.getMunicao()));
        jTextFieldDistancia.setText(longaDistancia);
    }

    public ArmaHeroi CarregaArmaHeroi() {
        ArmaHeroi arma = null;
        
        boolean longaDistancia = false;
        if((jTextFieldDistancia.getText().equals("sim")) || (jTextFieldDistancia.getText().equals("yes")) || (jTextFieldDistancia.getText().equals("true")))
            longaDistancia = true;
        
        int id = Integer.valueOf(jTF_id.getText());
        String nome = jTF_nome.getText();
        int dano = Integer.valueOf(jTF_dano.getText());
        int municao = Integer.valueOf(jTF_municao.getText());
...
public boolean bancoEstaAberto(boolean banco){
    ...
    private javax.swing.JTextField jTF_dano;
    private javax.swing.JTextField jTF_id;
    private javax.swing.JTextField jTF_municao;
