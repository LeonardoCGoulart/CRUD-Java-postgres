 ...
 * @author fabricio
 */
public class JanelaPoder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTF_natureza = new javax.swing.JTextField();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTF_natureza, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTF_natureza, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        if (dao.CriaConexao()) {
            if (dao.ConsultarTodos()) {
                ...
                try {
                    ...
                    Logger.getLogger(JanelaPoder.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    private void btn_inserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_inserirActionPerformed
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        Poder poder = CarregaPoder();
        if (dao.Inserir(poder)) {
            JOptionPane.showMessageDialog(this, "Poder inserido com sucesso.");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao inserir Poder.");
        }
    ...
    private void btn_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_alterarActionPerformed
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        Poder poder = CarregaPoder();
        if (dao.Alterar(poder)) {
            JOptionPane.showMessageDialog(this, "Poder alterado com sucesso.");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao alterar Poder.");
        }
    ...
    private void btn_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_excluirActionPerformed
       if(bancoEstaAberto(bancoLigado) == false)
        ...
        Poder poder = CarregaPoder();
        if (dao.Excluir(poder)) {
            JOptionPane.showMessageDialog(this, "Poder excluído com sucesso.");
            btn_primeiroActionPerformed(evt);
        } else {
            JOptionPane.showMessageDialog(this, "Poder ao excluir Heroi.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaPoder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaPoder().setVisible(true);
            }
        });
    }

    public void ExibeRegistro(Poder poder) {
        jTF_id.setText(String.valueOf(poder.getId()));
        jTF_nome.setText(poder.getNome());
        jTF_dano.setText(String.valueOf(poder.getDano()));
        jTF_natureza.setText(String.valueOf(poder.getNatureza()));
    }

    public Poder CarregaPoder() {
        Poder poder = null;
        int id = Integer.valueOf(jTF_id.getText());
        String nome = jTF_nome.getText();
        int dano = Integer.valueOf(jTF_dano.getText());
        String natureza = jTF_natureza.getText();
...
public boolean bancoEstaAberto(boolean banco){
    ...
    private javax.swing.JTextField jTF_natureza;
